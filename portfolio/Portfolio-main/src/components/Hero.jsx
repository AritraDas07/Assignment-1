...
const Hero = memo(function Hero() {
  ...
  return (
    ...
    >
      {/* Hero Name Glow */}
      <div className="hero-name-glow absolute inset-0" />
      ...
      >
        ...
        <div>
          <motion.h1
            ...
            className={`font-black lg:text-[90px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-20 text-white tracking-[-0.02em]`}
          >
            Hi, I&apos;m{" "}
            <motion.span
              ...
              className="text-transparent bg-clip-text bg-gradient-to-r from-[#915EFF] via-[#06b6d4] to-[#915EFF] text-[60px] lg:text-[110px] block font-black"
            >
              Himanshu
            </motion.span>
          </motion.h1>
      ...
      >
        <div className="floating-badge" style={{ right: '200px', top: '220px' }}>
          ⚛️ React Native
        </div>
        <div className="floating-badge" style={{ right: '80px', top: '320px' }}>
          🚀 Full-Stack
        </div>
        <div className="floating-badge" style={{ right: '240px', top: '420px' }}>
          💻 Open Source
        </div>
      </motion.div>
      ...
      >
        <a href="#about">
          <div className="w-[35px] h-[64px] rounded-3xl border-4 border-secondary/40 flex justify-center items-start p-2 cursor-pointer">
            <motion.div
              animate={{
                y: [0, 24, 0],
              }}
