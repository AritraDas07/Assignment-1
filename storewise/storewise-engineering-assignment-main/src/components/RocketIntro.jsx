...
const RocketIntro = ({ onComplete }) => {
  ...
  return (
    <div
      ref={containerRef}
      className={`fixed inset-0 z-[100] overflow-hidden transition-opacity duration-[1500ms] ${
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden hover:pointer-events-none focus:pointer-events-none" style={{ pointerEvents: 'none' }}>
      ...
      >
        <div className={phase === "launching" ? "origin-center animate-[shake_0.1s_ease-in-out_infinite]" : ""}>
          <img
            src="/rocket.png"
            alt="Rocket"
            width={150}
